...
// Consulta para pegar todas as receitas, incluindo a coluna 'image'
...
<body>
  ...
  <form action="search_results.php" method="GET" class="d-flex">
    <input class="form-control me-2" type="search" name="query" placeholder="Buscar receita" aria-label="Search" style="max-width: 200px;">
    <button class="btn btn-dark" type="submit">Buscar</button>
    
</form>
</div>
<div style="margin-left: 30px; display:flex; margin-top:20px">
    <p>Filtrar por:</p>
    <a href="search_results.php?tipo=Salgada" class="btnUser">Salgado</a>
    <a href="search_results.php?tipo=Doce" class="btnUser">Doce</a>
    <style>
        .btnUser {
            color: black;
  ...
  <h1 class="receitastitulo"> Receitas </h1>

</ul>
  <div class="botaoFiltro"> 
  <a href="add_recipe.php" class="btn btn-dark">Publique a sua receita também!</a>
  </div>
...
<div class="container">
    ...
    <div class="row" style="--bs-gutter-x: 0rem;">
        ...
        <?php if ($result->num_rows > 0): ?>
            <?php while($row = $result->fetch_assoc()): ?>
                <div class="col-sm" style="align-items: center; justify-content: center; display: flex; margin-top: 20px;">
                    <div class="card" style="width: 20rem;">
                        <!-- Exibir imagem da receita ou imagem padrão caso não exista -->
                        <img src="<?= $row['image'] ? htmlspecialchars($row['image']) : 'imagens/default.png'; ?>" 
                             class="card-img-top" 
                             alt="Imagem da receita"
                             style="width: 100%; height: 238.41px; object-fit: cover;">
                        <div class="card-body">
                            <!-- Nome da receita -->
                            <h5 class="card-title"><?= htmlspecialchars($row['name']); ?></h5>
                            <!-- Texto com resumo dos ingredientes -->
                            <p class="card-text">Feita por <?= htmlspecialchars(substr($row['user_name'], 0, 100)); ?></p>
                            <!-- Link que leva até a página da receita -->
            ...
            <?php endwhile; ?>
        <?php else: ?>
            <p>Nenhuma receita foi cadastrada ainda. <a href="add_recipe.php">Seja o primeiro!</a> </p>
        <?php endif; ?>
    ...
    <!--Cards usuado em todas receitas, nele contém:-->
                        ...
                        <div class="row gy-4 gx-5">
                          ...
                          <!--Informações rápidas e úteis para o usuário-->
                            ...
                            <div class="col-lg-4 col-md-6">
                                ...
                                <p class="small text-muted mb-0">&copy; Copyrights. Todos direitos reservados. <a class="linkEstilo1" href="#">Quinta das receitas</a></p>
                            </div>
